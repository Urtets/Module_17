...
@router_p.get('/')
async def all_products(db: Annotated[Session, Depends(),]):
...
async def create_product(db: Annotated[Session, Depends()], create_product: CreateProduct):
...
async def product_detail(db: Annotated[Session, Depends()], product_slug: str):
...
async def update_product(db: Annotated[Session, Depends()], product_slug: str, update_product_model: CreateProduct):
...
async def delete_product(db: Annotated[Session, Depends()], product_id: int):
